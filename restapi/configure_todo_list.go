...
import (
	...
	"github.com/sanshirookazaki/todo/restapi/operations"
	"github.com/sanshirookazaki/todo/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../todo --name TodoList --spec ../swagger.yml
